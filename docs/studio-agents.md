...
**Source files**:
- Agent: `src/fireflyframework_agentic_studio/assistant/agent.py`
- API: `src/fireflyframework_agentic_studio/api/assistant.py`
...
**Source files**:
- Agent: `src/fireflyframework_agentic_studio/assistant/oracle.py`
- Notifications: `src/fireflyframework_agentic_studio/assistant/oracle_notifications.py`
- API: `src/fireflyframework_agentic_studio/api/oracle.py`
...
**Source files**:
- Agent: `src/fireflyframework_agentic_studio/assistant/smith.py`
- API: `src/fireflyframework_agentic_studio/api/smith.py`
