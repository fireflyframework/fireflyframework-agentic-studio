...
def _build_oracle_instructions(user_name: str) -> str:
    ...
    from fireflyframework_agentic_studio.assistant.agent import _FRAMEWORK_KNOWLEDGE
...
def create_oracle_agent(
    ...
    """
    from fireflyframework_agentic_studio.assistant.agent import _resolve_assistant_model
