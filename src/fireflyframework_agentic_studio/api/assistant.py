...
def create_assistant_router() -> APIRouter:
    ...
    async def get_chat_history(project: str):
        from fireflyframework_agentic_studio.assistant.history import load_chat_history
    ...
    async def save_chat_history_endpoint(project: str, body: SaveHistoryRequest):
        from fireflyframework_agentic_studio.assistant.history import save_chat_history
    ...
    async def delete_chat_history(project: str):
        from fireflyframework_agentic_studio.assistant.history import clear_chat_history
    ...
    async def assistant_ws(websocket: WebSocket, project: str = Query(default="")) -> None:
        ...
        from fireflyframework_agentic_studio.assistant.agent import (
            CanvasEdge,
            CanvasNode,
            CanvasState,
