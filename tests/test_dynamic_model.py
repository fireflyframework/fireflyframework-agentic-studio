...
from fireflyframework_agentic_studio.codegen.generator import _get_default_model, generate_python
from fireflyframework_agentic_studio.codegen.models import GraphModel, GraphNode, NodeType
...
class TestArchitectDefaultModel:
    def test_architect_instructions_include_default_model(self, tmp_path):
        ...
        from fireflyframework_agentic_studio.assistant.agent import _build_instructions
