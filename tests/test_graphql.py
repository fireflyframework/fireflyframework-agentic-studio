...
from fireflyframework_agentic_studio.config import StudioConfig  # noqa: E402
from fireflyframework_agentic_studio.server import create_studio_app  # noqa: E402
...
class TestGraphQLFallback:
    def test_fallback_router_created_when_strawberry_missing(self, monkeypatch: pytest.MonkeyPatch):
        ...
        import fireflyframework_agentic_studio.api.graphql_api as gql_mod
